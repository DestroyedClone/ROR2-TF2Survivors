...
namespace ROR2_Scout.Modules
{
    public static class Tokens
    {
        public static void AddTokens()
        {
            ...
            LanguageAPI.Add("SCOUT_NAME", "Teufort Scout");
            LanguageAPI.Add("SCOUT_DESCRIPTION", desc);
            LanguageAPI.Add("SCOUT_SUBTITLE", "Force of Nature");
            LanguageAPI.Add("SCOUT_LORE", "Born and raised in Boston, Massachusetts, USA, the Scout is a fast-running scrapper with a baseball bat and a snarky \"in-your-face\" attitude.");
            LanguageAPI.Add("SCOUT_OUTRO_FLAVOR", "..and so he left, irradiated beyond life.");

            LanguageAPI.Add("SCOUTBODY_RED_SKIN_NAME", "Reliable Excavation Demolition");
            LanguageAPI.Add("SCOUTBODY_BLU_SKIN_NAME", "Builder's League United");
            LanguageAPI.Add("SCOUTBODY_LIME_SKIN_NAME", "The Bitter Taste of Defeat and Lime");

            LanguageAPI.Add("SCOUTBODY_MALE_BONK_SKIN_NAME", "Bonk Boy");
            LanguageAPI.Add("SCOUTBODY_FEMALE_BONK_SKIN_NAME", "Bonk Girl");

            LanguageAPI.Add("SCOUT_PASSIVE_NAME", "Irradiated Biology");
            LanguageAPI.Add("SCOUT_PASSIVE_DESCRIPTION", "Scout can <style=cIsUtility>double jump</style>." +
                "\n[MVM+] Scout has an <style=cIsUtility>increased interaction</style> range."); //from 3 to 5

            LanguageAPI.Add("SCOUT_PRIMARY_SCATTERGUN_NAME", "Scattergun");
            LanguageAPI.Add("SCOUT_PRIMARY_SCATTERGUN_DESCRIPTION", "Fire a spread of bullets that deal <style=cIsDamage>6x80% damage</style>.");

            LanguageAPI.Add("SCOUT_PRIMARY_FORCENATURE_NAME", "Force 'a Nature");
            LanguageAPI.Add("SCOUT_PRIMARY_FORCENATURE_DESCRIPTION", "Fire a wide spread of bullets that deal <style=cIsDamage>8x60% damage</style>.\nDeals knockback to <style=cIsUtility>target and shooter<style>.");

            desc = "Fire a stream of bullets that deal <style=cIsDamage>70% damage</style>.\n<style=cIsUtility>Holds 12.</style>";
            LanguageAPI.Add("SCOUT_SECONDARY_PISTOL_NAME", "Pistol");
            LanguageAPI.Add("SCOUT_SECONDARY_PISTOL_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_SECONDARY_CLEAVER_NAME", "The Flying Guillotine");
            LanguageAPI.Add("SCOUT_SECONDARY_CLEAVER_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_SECONDARY_MILK_NAME", "Mad Milk");
            LanguageAPI.Add("SCOUT_SECONDARY_MILK_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_UTILITY_MARKDEATH_NAME", "Fan O' War");
            LanguageAPI.Add("SCOUT_UTILITY_MARKDEATH_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_UTILITY_SANDMAN_NAME", "Sandman");
            LanguageAPI.Add("SCOUT_UTILITY_SANDMAN_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_UTILITY_BLEEDBAT_NAME", "Boston Basher");
            LanguageAPI.Add("SCOUT_UTILITY_BLEEDBAT_DESCRIPTION", desc);

            desc = "Gain +50% attack speed, +50% movement speed, and max utility charges for 8 seconds.";
            LanguageAPI.Add("SCOUT_SPECIAL_FF2_NAME", "Empowered");
            LanguageAPI.Add("SCOUT_SPECIAL_FF2_DESCRIPTION", desc);

            desc = "Start with no equipment.";
            LanguageAPI.Add("SCOUT_EQUIPMENT_NONE_NAME", "None");
            LanguageAPI.Add("SCOUT_EQUIPMENT_NONE_DESCRIPTION", desc);
            ...
            LanguageAPI.Add("SCOUT_EQUIPMENT_BONK_NAME", "None");
            LanguageAPI.Add("SCOUT_EQUIPMENT_BONK_DESCRIPTION", desc);

            desc = "Use to deal <style=cIsDamage>+35% more damage</style>, but <style=cDeath>take +50% more damage</style> for 8 seconds.";
            LanguageAPI.Add("SCOUT_EQUIPMENT_COLA_NAME", "None");
            LanguageAPI.Add("SCOUT_EQUIPMENT_COLA_DESCRIPTION", desc);
